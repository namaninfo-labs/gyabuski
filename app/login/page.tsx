          ...
          >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 6px 25px rgba(124,58,237,0.55), 0 0 50px rgba(124,58,237,0.25)'
                e.currentTarget.style.transform = 'translateY(-1px)'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = 'linear-gradient(135deg, #7C3AED 0%, #6d28d9 100%)'
                e.currentTarget.style.boxShadow = '0 4px 20px rgba(124,58,237,0.40), 0 0 40px rgba(124,58,237,0.15)'
